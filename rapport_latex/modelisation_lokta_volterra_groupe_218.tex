...
\begin{document}
    ...
    \section{Modélisation à état continu}
        ...
        On remarque que les solutions Scipy et Euler explicite convergent bien vers les valeurs d'équilibre.
        \begin{figure}[!h]
        ...
        Le graphique d'évolution de la population de requins, de la population de sardines et de l'effort de pêche est donné ci dessous. On remarque la convergence vers le point d'équilibre.
        \begin{center}
